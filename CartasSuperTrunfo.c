    ...
    int main() {
        ...
        float area1, pib1, area2, pib2, densiPopula1, percapta1, densiPopula2, percapta2;
        ...
        printf("Carta 1:\n Estado: %s \n Código: %s \n Nome da Cidade: %s \n População: %i \n Área: %.2f km² \n PIB: %.2f Bilhões de reais \n Número de pontos turísticos: %i \n Densidade Populacional: %.2f hab/km² \n PIB per Capita: R$ %2.f \n", estadoA, codCarta1, cidade1, populacao1, area1, pib1, nPontoTur1, densiPopula1, percapta1);
        
        printf("Carta 2:\n Estado: %s \n Código: %s \n Nome da Cidade: %s \n População: %i \n Área: %.2f km² \n PIB: %.2f Bilhões de reais \n Número de pontos turísticos: %i \n Densidade Populacional: %.2f hab/km² \n PIB per Capita: R$ %2.f \n", estadoB, codCarta2, cidade2, populacao2, area2, pib2, nPontoTur2, densiPopula2, percapta2);
